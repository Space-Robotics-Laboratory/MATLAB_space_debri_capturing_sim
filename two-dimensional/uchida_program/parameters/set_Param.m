...
Param.TargetVelocity0     = [ .00 -.0 0 ]';              % 初期並進速度 ;SV.v0
...
% 物理係数設定
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Param.ContactDamp  = 8;%8;%20;         % 接触力減衰係数
Param.ContactElast = 9000;%9000;%1000;      % 接触力弾性係数

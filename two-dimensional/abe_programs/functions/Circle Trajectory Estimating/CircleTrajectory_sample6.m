...
sen = 2;
salmon = [ 255/255, 192/255, 203/255 ];
...
writerObj = VideoWriter( 'C:\Users\falsi\Desktop\中間審査\Presentation\Estimation.avi' );
...
% sen_p = plot( senx_p, seny_p, 'k-', 'LineWidth', sen );

ten3 = [ ten2' 0 ]' + rpy2dc([ 0 0 -pi/2 ])' * ( [ ten1' 0 ]' - [ ten2' 0 ]' );% / norm( [ ten1' 0 ]' - [ ten2' 0 ]' );
ten4 = [ ten1' 0 ]' + rpy2dc([ 0 0  pi/2 ])' * ( [ ten2' 0 ]' - [ ten1' 0 ]' );% / norm( [ ten2' 0 ]' - [ ten1' 0 ]' );
ten3 = ten3(1:2,1);
ten4 = ten4(1:2,1);
sikakux_p = [ ten1(1,1), ten2(1,1), ten3(1,1), ten4(1,1), ten1(1,1) ];
sikakuy_p = [ ten1(2,1), ten2(2,1), ten3(2,1), ten4(2,1), ten1(2,1) ];

frame_n = 1;


fill_p = fill( senx_p, seny_p, salmon, 'LineWidth', sen );
fills_p = fill( sikakux_p, sikakuy_p, salmon, 'LineWidth', sen );
en_est_p = fill( en_estx_p + r0s*1.4, en_esty_p + r0c*1.4, 'y', 'LineWidth', sen );
en_p = fill( enx_p + r0s/2, eny_p + r0c/2, 'k', 'LineWidth', sen );
ten1_p = fill( ten1x_p + r0s, ten1y_p + r0c, 'r', 'LineWidth', sen );
ten2_p = fill( ten2x_p + r0s, ten2y_p + r0c, 'b', 'LineWidth', sen );
sen_p = plot( [-.05 .8+.05], [-.05 .8+.05], 'k-', 'LineWidth', sen );
...
set( fill_p, 'XData', senx_p, 'YData', seny_p );
set( fills_p, 'XData', sikakux_p, 'YData', sikakuy_p );
set( en_est_p, 'XData', en_estx_p + r0s*1.2, 'YData', en_esty_p + r0c*1.2 );
set( en_p, 'XData', enx_p + r0s/2, 'YData', eny_p + r0c/2 );
set( ten1_p, 'XData', ten1x_p + r0s, 'YData', ten1y_p + r0c );
set( ten2_p, 'XData', ten2x_p + r0s, 'YData', ten2y_p + r0c );
...
set( sen_p, 'XData', [-.05 .8+.05], 'YData', [-.05 .8+.05] );

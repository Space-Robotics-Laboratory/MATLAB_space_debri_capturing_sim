...
plot( normal_traj_est(1,1), normal_traj_est(2,1), 'g-o', 'MarkerFaceColor', 'm', 'LineWidth', 1 );
plot( [ normal_traj_est(1,1) normal_traj_est_tmp(1,1) ] , [ normal_traj_est(2,1) normal_traj_est_tmp(2,1) ], 'm-', 'LineWidth', 1 );
plot( en_est(1,1) , en_est(2,1), 'g-o', 'LineWidth', 5 );
plot( en(1,1), en(2,1), 'k-o', 'LineWidth', 1 );
...
plot( ten1_dash_est(1,1), ten1_dash_est(2,1), 'r+', 'LineWidth', 1 );
plot( ten2_dash_est(1,1), ten2_dash_est(2,1), 'b+', 'LineWidth', 1 );
plot( [ ten1_tmp(1,1) ten1_dash_est(1,1) ten1(1,1) ],[ ten1_tmp(2,1) ten1_dash_est(2,1) ten1(2,1) ], 'r-', 'LineWidth', 1 );
plot( [ ten2_tmp(1,1) ten2_dash_est(1,1) ten2(1,1) ],[ ten2_tmp(2,1) ten2_dash_est(2,1) ten2(2,1) ], 'b-', 'LineWidth', 1 );
% end
...
legend( strcat( ' r_1 = ', num2str( r1_est ), ' [m]' ), strcat( ' r_2 = ', num2str( r2_est ), ' [m]' ) , strcat( 'φ_1 = ', num2str( fai1 * 180/pi ), ' [deg]' ), strcat( 'φ_2 = ', num2str( fai2 * 180/pi ), ' [deg]' ) );

...
est_geo = Obs1 + half_taikaku_chohou / norm( Obs2 - Obs1 ) * rpy2dc( 0, 0, ( pi/2 - theta_chohou ) )' * ( Obs2 - Obs1 );
...
est_r1 = norm( est_P - Obs1 );
est_r2 = norm( est_P - Obs2 );

...
= Shikaku_FourTips_RIGHT_CONTACT_v03( LP_d, SV_d, SV_ts, d_time, half_side, r_tip, contact_flag_R, contactflag_R, shikaku1, shikaku2, shikaku3, shikaku4, ...
                        l_side_min, l_corner_min, ts_geo, q0, Rg_d, POS_eR, delta_tmp_R, curPosAP3_tmp_R, l1, l2, l3, l4, gamma1, gamma2, gamma3, gamma4, cof_R, kkk, ccc, jointsR, k_p, c_p )
